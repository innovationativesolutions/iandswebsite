...
export const Hero = () => {
  ...
  return (
    <>
      <Container className="flex flex-wrap justify-center px-4 sm:px-6 lg:px-8">
        <div className="flex items-center w-full">
          <div className="max-w-4xl mb-8 mx-auto text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-gray-800 dark:text-white">
              Technology & Management Services that Move You Forward
            </h1>
            <p className="py-5 text-base sm:text-lg md:text-xl leading-relaxed text-gray-500 dark:text-gray-300 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col items-center space-y-4 sm:space-y-0 sm:space-x-4 sm:flex-row sm:justify-center">
              <a
                href="#contact"
                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-medium text-center text-white bg-indigo-600 rounded-md hover:bg-indigo-700 transition-colors duration-300">
                Talk to an Expert
              </a>
              <a
                href="#services"
                onClick={(e) => handleSmoothScroll(e, 'services')}
                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-medium text-center text-gray-800 bg-gray-200 rounded-md dark:text-white dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-300">
                Explore Services
              </a>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center text-center">
          ...
          <div className="grid gap-4 sm:gap-6 mt-8 sm:mt-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {valuePillars.map((pillar, index) => {
              ...
              return (
                <div key={index} className="p-4 sm:p-6 text-left bg-gray-100 rounded-lg dark:bg-gray-800 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:shadow-indigo-200/50 dark:hover:shadow-indigo-800/50">
                   <div className="flex items-start sm:items-center mb-3">
                    <IconComponent className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-600 dark:text-indigo-400 mr-3 flex-shrink-0 mt-1 sm:mt-0" />
